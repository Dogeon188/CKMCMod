...
public class MyFoodComponents {
    ...
    public static final FoodComponent OYSTER_VERMICELLI = newFood(7, 1.8f);
    ...
    public static final FoodComponent BEEF_NOODLES = newFood(10, 2.4f);
    public static final FoodComponent BRAISED_PORK_RICE = newFood(8, 2.1f);
